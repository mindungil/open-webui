...
{#if loaded}
	...
	<div class="w-full max-h-full flex justify-center">
		...
		{#if !edit || (edit && model)}
			<form
				class="flex flex-col md:flex-row w-full gap-3 md:gap-6 gpts-model-editor"
			...
			>
				...
				<div class="w-full">
					...
					{#if preset}
						<div class="my-3">
							<div class="rounded-xl bg-gray-50 dark:bg-gray-900 p-4 border border-gray-200 dark:border-gray-800">
								...
								<div>
									<select
										class="text-sm w-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 outline-hidden rounded-lg px-3 py-2.5"
					...
					<div class="my-3">
						<div class="rounded-xl bg-gray-50 dark:bg-gray-900 p-4 border border-gray-200 dark:border-gray-800">
							<div class="flex items-center justify-between mb-3">
								<div class="flex items-center gap-3">
									...
									<div>
										...
										<div class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
											이 GPT가 무엇을 하는지 간단히 설명하세요
										</div>
									</div>
								</div>

								<button
									class="px-3 py-1.5 text-xs flex rounded-lg transition bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 border border-gray-300 dark:border-gray-700"
									type="button"
								...
								>
									{#if !enableDescription}
										<span class="self-center text-gray-700 dark:text-gray-300">{$i18n.t('Default')}</span>
									{:else}
										<span class="self-center text-gray-700 dark:text-gray-300">{$i18n.t('Custom')}</span>
									{/if}
								</button>
							</div>
							...
							{#if enableDescription}
								<Textarea
									className=" text-sm w-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 outline-hidden resize-none overflow-y-hidden rounded-lg px-3 py-2"
						...
						<div class="rounded-xl bg-gray-50 dark:bg-gray-900 p-4 border border-gray-200 dark:border-gray-800">
							<div class="flex items-center gap-3 mb-3">
								...
								<div>
									...
									<div class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
										이 GPT를 누가 사용하고 수정할 수 있는지 설정하세요
									</div>
								</div>
							</div>
							<div class="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg p-3">
								<AccessControl
									bind:accessControl
						...
						<div class="rounded-xl bg-gray-50 dark:bg-gray-900 p-4 border border-gray-200 dark:border-gray-800">
							<div class="flex items-center gap-3 mb-3">
								...
								<div>
									...
									<div class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
										모델의 역할과 행동 방식을 정의하세요 (예: 당신은 친절한 AI 어시스턴트입니다)
									</div>
								</div>
							</div>
						...
						<div class="rounded-xl bg-gray-50 dark:bg-gray-900 p-4 border border-gray-200 dark:border-gray-800">
							<div class="flex items-center gap-3 mb-3">
								...
								<div>
									...
									<div class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
										파일을 업로드하면 모델이 해당 정보를 참고하여 더 정확한 답변을 제공합니다
									</div>
								</div>
							</div>
